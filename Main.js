...
function start(client) {
    ...
    client.onMessage().then(async message => {
            if (message != null) {
                //Configure variables for use in the modules
                let bodyText
                ...
                if (message.quotedMsg) { //if a message was quoted
                ...
                if (!restUsers.includes(messageAuthor) && !restGroups.includes(chatID) && !restGroupsSpam.includes(chatID)) {
