class Strings {
    static strings = {
        ...
        "add_filter": {
            "he": /^הוסף פילטר/i, "en": /^Add filter/i, "la": "Crea invenientem", "ar": ""
        }, "add_filter_reply": {
            ...
            "he": /^הסר פילטר/i, "en": /^Remove filter/i, "la": "Dele invenientem", "ar": ""
        }, "remove_filter_reply": {
            ...
            "he": /^ערוך פילטר/i, "en": /^Edit filter/i, "la": "Recense invenientem", "ar": ""
        }, "edit_filter_reply": {
            ...
            "he": /^הראה פילטרים/i, "en": /^Show filters/i, "la": "Ostende invenientes", "ar": ""
        }, "image": {
            "he": "[תמונה]", "en": "[Image]", "la": null, "ar": ""
        }, "video": {
            "he": "[וידאו]", "en": "[Video]", "la": null, "ar": ""
        }, //tags
        "tag": {
            "he": /^תייג /i, "en": /^Tag /i, "la": "Clama ad ", "ar": ""
            ...
            "he": /^הוסף חבר לתיוג/i, "en": /^Add tag buddy/i, "la": "Adde amicum", "ar": ""
        }, "add_tag_reply": {
            ...
            "he": /^הסר חבר מתיוג/i, "en": /^Remove tag buddy/i, "la": "Dele amicum", "ar": ""
        }, "remove_tag_reply": {
            ...
            "he": /^תייג כולם/i, "en": /^Tag everyone/i, "la": "Clama ad quoque", "ar": ""
        }, "show_tags": {
            "he": /^הראה רשימת חברים לתיוג/i, "en": /^Show tag buddies/i, "la": "Ostende amici", "ar": ""
        }, "check_tags": {
            "he": /^בדוק היכן תייגוני/i, "en": /^Check where I've been tagged/i, "la": null, "ar": ""
        }, "check_tags_reply": {
            ...
            "he": /^נקה תיוגיי/i, "en": /^Clear my tags/i, "la": null, "ar": ""
        }, "clear_tags_reply": {
        ...
        "birthday_wishes_reply": {
            ...
            "he": /^הוסף יום הולדת/i, "en": /^Add birthday/i, "la": "Adde natalis dies", "ar": ""
        }, "add_birthday_reply": {
            ...
            "he": /^הסר יום הולדת/i, "en": /^Remove birthday/i, "la": "Dele natalis dies", "ar": ""
            ...
            "he": /^הראה ימי הולדת/i, "en": /^Show birthdays"/i, "la": "Ostende natalis dies", "ar": ""
            ...
            "he": /^הוסף קבוצה לרשימת התפוצה/i, "en": /^Add group to birthday message/i, "la": null, "ar": ""
            ...
            "he": /^הסר קבוצה מרשימת התפוצה/i, "en": /^Remove group from birthday message/i, "la": null, "ar": ""
        ...
        "set_permissions": {
            "he": /^קבע הרשאה ל/i, "en": /^Define permission for/i, "la": null, "ar": ""
            ...
            "he": /פילטרים/i, "en": /filters/i, "la": null, "ar": ""
        }, "tags_permission_type": {
            "he": /תיוגים/i, "en": /tags/i, "la": null, "ar": ""
        }, "handleFilters_permission_type": {
            "he": /ניהול-פילטרים/i, "en": /handle-Filters/i, "la": null, "ar": ""
        }, "handleTags_permission_type": {
            "he": /ניהול-תיוגים/i, "en": /handle-Tags/i, "la": null, "ar": ""
        }, "handleBirthdays_permission_type": {
            "he": /ניהול-ימיהולדת/i, "en": /handle-Birthdays/i, "la": null, "ar": ""
        }, "handleShows_permission_type": {
            "he": /ניהול-הראה/i, "en": /handle-Shows/i, "la": null, "ar": ""
        }, "handleOther_permission_type": {
            "he": /ניהול-שונות/i, "en": /handle-Other/i, "la": null, "ar": ""
        }, "filters_permission_type_replace": {
            "he": "פילטרים", "en": "filters", "la": null, "ar": ""
        }, "tags_permission_type_replace": {
            "he": "תיוגים", "en": "tags", "la": null, "ar": ""
        }, "handleFilters_permission_type_replace": {
            "he": "ניהול-פילטרים", "en": "handle-Filters", "la": null, "ar": ""
        }, "handleTags_permission_type_replace": {
            "he": "ניהול-תיוגים", "en": "handle-Tags", "la": null, "ar": ""
        }, "handleBirthdays_permission_type_replace": {
            "he": "ניהול-ימיהולדת", "en": "handle-Birthdays", "la": null, "ar": ""
        }, "handleShows_permission_type_replace": {
            "he": "ניהול-הראה", "en": "handle-Shows", "la": null, "ar": ""
        }, "handleOther_permission_type_replace": {
            "he": "ניהול-שונות", "en": "handle-Other", "la": null, "ar": ""
        }, "muted_permission_level": {
            "he": /מושתק/, "en": /Muted/i, "la": null, "ar": ""
        }, "regular_permission_level": {
            "he": /רגיל/, "en": /Regular/i, "la": null, "ar": ""
        }, "admin_permission_level": {
            "he": /מנהל/, "en": /Admin/i, "la": null, "ar": ""
        }, "developer_permission_level": {
            "he": /אלוהים/, "en": /God/i, "la": null, "ar": ""
        }, "muted_permission_level_replace": {
            "he": "מושתק", "en": "Muted", "la": null, "ar": ""
        }, "regular_permission_level_replace": {
            "he": "רגיל", "en": "Regular", "la": null, "ar": ""
        }, "admin_permission_level_replace": {
            "he": "מנהל", "en": "Admin", "la": null, "ar": ""
        }, "developer_permission_level_replace": {
            "he": "אלוהים", "en": "God", "la": null, "ar": ""
        }, "show_group_function_permissions": {
            "he": /^הראה הרשאות פונקציות/i, "en": /^Show function permissions/i, "la": null, "ar": ""
        }, "show_group_user_permissions": {
            "he": /^הראה הרשאות אנשים/i, "en": /^Show people permissions/i, "la": null, "ar": ""
        }, "mute_participant": {
            "he": /^השתק /i, "en": /^Mute /i, "la": null, "ar": ""
            ...
            "he": /^הסר השתקה/i, "en": /^Unmute person/i, "la": null, "ar": ""
        ...
        "scan_link": {
            "he": /^סרוק/i, "en": /^Scan /i, "la": /^Examina /i, "ar": ""
        }, "link_validity_error": {
            ...
            "he": /^הפוך לסטיקר/i, "en": /^Create sticker/i, "la": "Fac hoc imaginem", "ar": ""
        }, "crop_sticker": {
            "he": /^ללא חיתוך/i, "en": /^without cropping/i, "la": null, "ar": ""
            ...
            "he": /^צור סקר/i, "en": /^Create survey/i, "la": "Crea census", "ar": ""
        }, "survey_title": {
            "he": /כותרת - (.)+/, "en": /Title - (.)+/, "la": /Nomen - (.)+/, "ar": ""
        }, "survey_subtitle": {
            "he": /כותרת משנה - (.)+/, "en": /Subtitle - (.)+/, "la": /Subnomen - (.)+/, "ar": ""
        }, "third_survey_title": {
            "he": /כותרת שלישית - (.)+/, "en": /Third title - (.)+/, "la": /Nomen tertium - (.)+/, "ar": ""
        }, "survey_button_1": {
            "he": /כפתור 1 - (.)+/, "en": /Button 1 - (.)+/, "la": /Buttonus 1 - (.)+/, "ar": ""
        }, "survey_button_2": {
            "he": /כפתור 2 - (.)+/, "en": /Button 2 - (.)+/, "la": /Buttonus 2 - (.)+/, "ar": ""
        }, "survey_button_3": {
            "he": /כפתור 3 - (.)+/, "en": /Button 3 - (.)+/, "la": /Buttonus 3 - (.)+/, "ar": ""
        }, "survey_title_replace": {
            "he": "כותרת -", "en": "Title -", "la": "Nomen -", "ar": ""
        }, "second_survey_title_replace": {
            "he": "כותרת משנה -", "en": "Body -", "la": "Subnomen -", "ar": ""
        }, "third_survey_title_replace": {
            "he": "כותרת שלישית -", "en": "Footer -", "la": "Nomen tertium -", "ar": ""
            ...
            "he": /^הגדרת אינטרנט/i, "en": /^Internet definition/i, "la": null, "ar": ""
            ...
            "he": /^תרגם ל/i, "en": /^Translate To/i, "la": null, "ar": ""
        }, "translate_reply": {
            "he": "*תרגום*: \n %s \n משפה (קוד שפה): \n %s",
        ...
        "show_profile": {
            "he": /^פרופיל/i, "en": /^Profile/i, "la": null, "ar": ""
            ...
            "he": /^שלח קישור לאתר/i, "en": /^Send website link/i, "la": "Ostende situs texti", "ar": ""
        }, "show_webpage_reply": {
        ...
        "add_reminder": {
            "he": /^הוסף תזכורת/i, "en": /^Add reminder/i, "la": null, "ar": ""
        }, "add_reminder_reply": {
            ...
            "he": /^הסר תזכורת/i, "en": /^Remove reminder/i, "la": null, "ar": ""
            ...
            "he": /^הראה תזכורות/i, "en": /^Show reminders/i, "la": null, "ar": ""
        }, "show_reminder_error": {
            ...
            "he": /^חוזרת/i, "en": /^Repeat/i, "la": null, "ar": ""
        },//language
        "change_language": {
            "he": /^שנה שפה/i, "en": /^Change language to/i, "la": "Muta lingua ad", "ar": ""
            ...
            "he": /^עזרה$/i, "en": /^Help$/, "la": /^Auxilium$/i, "ar": ""
        }, "help_reply": {
