class Strings {
    static strings = {
        ...
        "make_sticker": {
            ...
            "he": /^אנגלית/i, "en": /^Engish/i, "la": null
        }, "hebrew_lang": {
            "he": /^עברית/i, "en": /^Hebrew/i, "la": null
        }, "chinese_lang": {
            "he": /^סינית/i, "en": /^Chinese/i, "la": null
        }, "mandarin_lang": {
            "he": /^מנדרינית/i, "en": /^Mandarin/i, "la": null
        }, "hindi_lang": {
            "he": /^הינדית/i, "en": /^Hindi/i, "la": null
        }, "indian_lang": {
            "he": /^הודית/i, "en": /^Indian/i, "la": null
        }, "spanish_lang": {
            "he": /^ספרדית/i, "en": /^Spanish/i, "la": null
        }, "french_lang": {
            "he": /^צרפתית/i, "en": /^French/i, "la": null
        }, "arabic_lang": {
            "he": /^ערבית/i, "en": /^Arabic/i, "la": null
        }, "bengali_lang": {
            "he": /^בנגלי/i, "en": /^Bengali/i, "la": null
        }, "russian_lang": {
            "he": /^רוסית/i, "en": /^Russian/i, "la": null
        }, "portuguese_lang": {
            "he": /^פורטוגזית/i, "en": /^Portugese/i, "la": null
        }, "indonesian_lang": {
            "he": /^אינדונזית/i, "en": /^Indonesian/i, "la": null
        }, "urdu_lang": {
            "he": /^אורדו/i, "en": /^Urdu/i, "la": null
        }, "italian_lang": {
            "he": /^איטלקית/i, "en": /^Italian/i, "la": null
        }, "persian_lang": {
            "he": /^פרסית/i, "en": /^Persian/i, "la": null
        }, "romanian_lang": {
