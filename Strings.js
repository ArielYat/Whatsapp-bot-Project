class Strings {
    static strings = {
        ...
        "add_filter": {
            "he": /^הוסף פילטר/i, "en": /^Add filter/i, "la": "Crea invenientem", "ar": null
        }, "add_filter_reply": {
            ...
            "he": /^הסר פילטר/i, "en": /^Remove filter/i, "la": "Dele invenientem", "ar": null
        }, "remove_filter_reply": {
            ...
            "he": /^ערוך פילטר/i, "en": /^Edit filter/i, "la": "Recense invenientem", "ar": null
        }, "edit_filter_reply": {
            ...
            "he": /^הראה פילטרים/i, "en": /^Show filters/i, "la": "Ostende invenientes", "ar": null
        }, "image": {
            "he": "[תמונה]", "en": "[Image]", "la": null, "ar": null
        }, "video": {
            "he": "[וידאו]", "en": "[Video]", "la": null, "ar": null
        }, //tags
        "tag": {
            "he": /^תייג /i, "en": /^Tag /i, "la": "Clama ad ", "ar": null
            ...
            "he": /^הוסף חבר לתיוג/i, "en": /^Add tag buddy/i, "la": "Adde amicum", "ar": null
        }, "add_tag_reply": {
            ...
            "he": /^הסר חבר מתיוג/i, "en": /^Remove tag buddy/i, "la": "Dele amicum", "ar": null
        }, "remove_tag_reply": {
            ...
            "he": /^תייג כולם/i, "en": /^Tag everyone/i, "la": "Clama ad quoque", "ar": null
        }, "show_tags": {
            "he": /^הראה רשימת חברים לתיוג/i, "en": /^Show tag buddies/i, "la": "Ostende amici", "ar": null
        }, "check_tags": {
            "he": /^בדוק היכן תייגוני/i, "en": /^Check where I've been tagged/i, "la": null, "ar": null
        }, "check_tags_reply": {
            ...
            "he": /^נקה תיוגיי/i, "en": /^Clear my tags/i, "la": null, "ar": null
        }, "clear_tags_reply": {
            ...
            "he": /^צור רשימה לתיוג/i, "en": /^Create tag list/i, "la": null, "ar": null
        ...
        "birthday_wishes_reply": {
            ...
            "he": /^הוסף יום הולדת/i, "en": /^Add birthday/i, "la": "Adde natalis dies", "ar": null
        }, "add_birthday_reply": {
            ...
            "he": /^הסר יום הולדת/i, "en": /^Remove birthday/i, "la": "Dele natalis dies", "ar": null
            ...
            "he": /^הראה ימי הולדת/i, "en": /^Show birthdays"/i, "la": "Ostende natalis dies", "ar": null
            ...
            "he": /^הוסף קבוצה לרשימת התפוצה/i, "en": /^Add group to birthday message/i, "la": null, "ar": null
            ...
            "he": /^הסר קבוצה מרשימת התפוצה/i, "en": /^Remove group from birthday message/i, "la": null, "ar": null
        ...
        "set_permissions": {
            "he": /^קבע הרשאה ל/i, "en": /^Define permission for/i, "la": null, "ar": null
            ...
            "he": /פילטרים/i, "en": /filters/i, "la": null, "ar": null
        }, "tags_permission_type": {
            "he": /תיוגים/i, "en": /tags/i, "la": null, "ar": null
        }, "handleFilters_permission_type": {
            "he": /ניהול_פילטרים/i, "en": /handle_Filters/i, "la": null, "ar": null
        }, "handleTags_permission_type": {
            "he": /ניהול_תיוגים/i, "en": /handle_Tags/i, "la": null, "ar": null
        }, "handleBirthdays_permission_type": {
            "he": /ניהול_ימיהולדת/i, "en": /handle_Birthdays/i, "la": null, "ar": null
        }, "handleShows_permission_type": {
            "he": /ניהול_הראה/i, "en": /handle_Shows/i, "la": null, "ar": null
        }, "handleOther_permission_type": {
            "he": /ניהול_שונות/i, "en": /handle_Other/i, "la": null, "ar": null
        }, "filters_permission_type_replace": {
            "he": "פילטרים", "en": "filters", "la": null, "ar": null
        }, "tags_permission_type_replace": {
            "he": "תיוגים", "en": "tags", "la": null, "ar": null
        }, "handleFilters_permission_type_replace": {
            "he": "ניהול_פילטרים", "en": "handle_Filters", "la": null, "ar": null
        }, "handleTags_permission_type_replace": {
            "he": "ניהול_תיוגים", "en": "handle_Tags", "la": null, "ar": null
        }, "handleBirthdays_permission_type_replace": {
            "he": "ניהול_ימיהולדת", "en": "handle_Birthdays", "la": null, "ar": null
        }, "handleShows_permission_type_replace": {
            "he": "ניהול_הראה", "en": "handle_Shows", "la": null, "ar": null
        }, "handleOther_permission_type_replace": {
            "he": "ניהול_שונות", "en": "handle_Other", "la": null, "ar": null
        }, "muted_permission_level": {
            "he": /מושתק/, "en": /Muted/i, "la": null, "ar": null
        }, "regular_permission_level": {
            "he": /רגיל/, "en": /Regular/i, "la": null, "ar": null
        }, "admin_permission_level": {
            "he": /מנהל/, "en": /Admin/i, "la": null, "ar": null
        }, "developer_permission_level": {
            "he": /אלוהים/, "en": /God/i, "la": null, "ar": null
        }, "muted_permission_level_replace": {
            "he": "מושתק", "en": "Muted", "la": null, "ar": null
        }, "regular_permission_level_replace": {
            "he": "רגיל", "en": "Regular", "la": null, "ar": null
        }, "admin_permission_level_replace": {
            "he": "מנהל", "en": "Admin", "la": null, "ar": null
        }, "developer_permission_level_replace": {
            "he": "אלוהים", "en": "God", "la": null, "ar": null
        }, "show_group_function_permissions": {
            "he": /^הראה הרשאות פונקציות/i, "en": /^Show function permissions/i, "la": null, "ar": null
        }, "show_group_user_permissions": {
            "he": /^הראה הרשאות אנשים/i, "en": /^Show people permissions/i, "la": null, "ar": null
        }, "mute_participant": {
            "he": /^השתק /i, "en": /^Mute /i, "la": null, "ar": null
            ...
            "he": /^הסר השתקה/i, "en": /^Unmute person/i, "la": null, "ar": null
        ...
        "scan_link": {
            "he": /^סרוק/i, "en": /^Scan /i, "la": /^Examina /i, "ar": null
        }, "link_validity_error": {
            ...
            "he": /^הפוך לסטיקר/i, "en": /^Create sticker/i, "la": "Fac hoc imaginem", "ar": null
        }, "crop_sticker": {
            "he": /^ללא חיתוך/i, "en": /^without cropping/i, "la": null, "ar": null
            ...
            "he": /^צור סקר/i, "en": /^Create survey/i, "la": "Crea census", "ar": null
        }, "survey_title": {
            "he": /כותרת - (.)+/, "en": /Title - (.)+/, "la": /Nomen - (.)+/, "ar": null
        }, "survey_subtitle": {
            "he": /כותרת משנה - (.)+/, "en": /Subtitle - (.)+/, "la": /Subnomen - (.)+/, "ar": null
        }, "third_survey_title": {
            "he": /כותרת שלישית - (.)+/, "en": /Third title - (.)+/, "la": /Nomen tertium - (.)+/, "ar": null
        }, "survey_button_1": {
            "he": /כפתור 1 - (.)+/, "en": /Button 1 - (.)+/, "la": /Buttonus 1 - (.)+/, "ar": null
        }, "survey_button_2": {
            "he": /כפתור 2 - (.)+/, "en": /Button 2 - (.)+/, "la": /Buttonus 2 - (.)+/, "ar": null
        }, "survey_button_3": {
            "he": /כפתור 3 - (.)+/, "en": /Button 3 - (.)+/, "la": /Buttonus 3 - (.)+/, "ar": null
        }, "survey_title_replace": {
            "he": "כותרת -", "en": "Title -", "la": "Nomen -", "ar": null
        }, "second_survey_title_replace": {
            "he": "כותרת משנה -", "en": "Body -", "la": "Subnomen -", "ar": null
        }, "third_survey_title_replace": {
            "he": "כותרת שלישית -", "en": "Footer -", "la": "Nomen tertium -", "ar": null
            ...
            "he": /^הגדרת אינטרנט/i, "en": /^Internet definition/i, "la": null, "ar": null
            ...
            "he": /^תרגם ל/i, "en": /^Translate To/i, "la": null, "ar": null
        }, "translate_reply": {
            "he": "*תרגום*: \n %s \n משפה (קוד שפה): \n %s",
            ...
            "he": /^הורד מוזיקה /i, "en": /^Download music /i, "la": null, "ar": null
            ...
            "he": "נתקלתי בשגיאה בזמן ההורדה - בדוק שבחרת קישור אמיתי",
            "en": "I've encountered a problem while downloading - check you've sent a real link",
            "la": null,
            "ar": null
        ...
        "show_profile": {
            "he": /^פרופיל/i, "en": /^Profile/i, "la": null, "ar": null
            ...
            "he": /^שלח קישור לאתר/i, "en": /^Send website link/i, "la": "Ostende situs texti", "ar": null
        }, "show_webpage_reply": {
        ...
        "add_reminder": {
            "he": /^הוסף תזכורת/i, "en": /^Add reminder/i, "la": null, "ar": null
        }, "add_reminder_reply": {
            ...
            "he": /^הסר תזכורת/i, "en": /^Remove reminder/i, "la": null, "ar": null
            ...
            "he": /^הראה תזכורות/i, "en": /^Show reminders/i, "la": null, "ar": null
        }, "show_reminder_error": {
            ...
            "he": /^חוזרת/i, "en": /^Repeat/i, "la": null, "ar": null
        },//language
        "change_language": {
            "he": /^שנה שפה/i, "en": /^Change language to/i, "la": "Muta lingua ad", "ar": null
            ...
            "he": /^עזרה$/i, "en": /^Help$/, "la": /^Auxilium$/i, "ar": null
        }, "help_reply": {
            "he": `*הוראות בעברית*_
*שפה:*
